...
class csTimer2excel:
    def __init__(self, input_file, output_file=None):
        ...
        self.sessions_df = self.sessions_df.astype(
            {
                "Name": "object",
                "Num solves": "int",
                "Date start": "object",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_file", "-i", type=str, help="The .txt file to be converted."
    )
    parser.add_argument(
        "--output_file", "-o", type=str, help="The .xlsx file to be created."
    )
